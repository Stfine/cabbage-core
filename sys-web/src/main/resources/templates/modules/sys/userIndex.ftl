	...
	<div class="page-container-custom">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span><@spring.message code="core.user.management"></@spring.message></span>
                </li>
            </ul>
        </div>
		...
		<div id="left" class="tree-bar">
            <div class="portlet blue-hoki box">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i> <@spring.message code="core.user.org"></@spring.message>
                    </div>
                    <div class="actions">
    ...
    <script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#officeContent').attr("src","${ctx}/sys/user/list?officeId="+id);
				}
			}
		};
