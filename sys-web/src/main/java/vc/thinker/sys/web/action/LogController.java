...
public class LogController extends BaseController {
	...
	@SecurityMapping(name="core.user.log.list",permGroup="core.user.logManagement",userType=SysUserContant.USER_TYPE_1)
	...
	@SecurityMapping(name="core.user.log.inLogList",permGroup="core.user.logManagement",userType=SysUserContant.USER_TYPE_1)
